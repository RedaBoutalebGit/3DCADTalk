  ...
  return (
    <>
        ...
        <div className="flex h-full flex-col">
          <div className="flex-initial p-2  border-gray-00 dark:border-gray-500  ">
            <div className=" z-50 flex items-center justify-between">
              <div className=" z-50 flex items-center space-x-4 bg-white">
                <div className=" z-50 w-4 h-1 rounded-full bg-gray-800 animate-pulse " />
                <h1 className="text-lg font-semibold">Design concept</h1>
                <button onClick={summary} className=" flex animate-ping  text-gray-800 px-4 py-2 rounded-md font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-950 focus:ring-offset-2 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90 dark:focus:ring-gray-300 motion-safe:animate-bounce">
      générer <RiSlideshow2Line />
            ...
            <iframe className='translate-y-[-12%]' src='https://fetchcfd.com/3d-viewer' height={720} />
